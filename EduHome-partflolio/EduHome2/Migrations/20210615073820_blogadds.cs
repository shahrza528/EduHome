...
{
    public partial class blogadds : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Lanuage", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MorganSlider", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MorganSlider_Position_PostionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LanuageId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Course_Assesments_AssesmentsId",
                        column: x => x.AssesmentsId,
                        principalTable: "Assesments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Course_Lanuage_LanuageId",
                        column: x => x.LanuageId,
                        principalTable: "Lanuage",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Course_Skill_SkillId",
                        column: x => x.SkillId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogtoTag", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlogtoTag_Blog_BlogID",
                        column: x => x.BlogID,
                        principalTable: "Blog",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogtoTag_Tags_TagsID",
                        column: x => x.TagsID,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursetoTag", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoursetoTag_Course_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Course",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CoursetoTag_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogtoTag_BlogID",
                table: "BlogtoTag",
                column: "BlogID");

            migrationBuilder.CreateIndex(
                name: "IX_BlogtoTag_TagsID",
                table: "BlogtoTag",
                column: "TagsID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Course_AssesmentsId",
                table: "Course",
                column: "AssesmentsId");

            migrationBuilder.CreateIndex(
                name: "IX_Course_LanuageId",
                table: "Course",
                column: "LanuageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoursetoTag_CourseId",
                table: "CoursetoTag",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CoursetoTag_TagsId",
                table: "CoursetoTag",
                column: "TagsId");

            migrationBuilder.CreateIndex(
                name: "IX_MorganSlider_PostionId",
                table: "MorganSlider",
                column: "PostionId");
